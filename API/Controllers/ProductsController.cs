...
namespace API.Controllers
{
        ...
        ) : BaseApiController
    {
        ...
        {
            // create expression tree - deferred execution
        ...
        public async Task<ActionResult<Product>> GetProduct(int id)
        {
            ...
            // beter voor read?: var entity = context.MyEntities.AsNoTracking().FirstOrDefault(e => e.Id == id);
        ...
        {
            var product = mapper.Map<Product>(productDto); // AutoMapper ook gebruiken in deze richting?
        ...
        public async Task<ActionResult> UpdateProduct(UpdateProductDto updateProductDto)
        {
            ...
            mapper.Map(updateProductDto, product); // AutoMapper ook gebruiken in deze richting?
