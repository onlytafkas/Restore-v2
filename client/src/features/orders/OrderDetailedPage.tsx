...
export default function OrderDetailedPage() {
    ...
    if (isLoading) return <Typography variant='h5'>Loading order detail...</Typography>
        ...
        <Card sx={{ p: 2, maxWidth: 'md', mx: 'auto' }}>
            ...
            <Box>
                ...
                <Box component='dl'>
                    ...
                    <Typography component='dd' variant='subtitle2' fontWeight='300'>
            ...
            <Box>
                ...
                <Box mx={3}>
                    ...
                    <Box component='dl' display='flex' justifyContent='space-between'>
                        ...
                        <Typography component='dd' variant='subtitle2' fontWeight='300' color='green'>
                ...
                <Box component='dl' display='flex' justifyContent='space-between' mx={3}>
                    ...
                    <Typography component='dd' variant='subtitle2' fontWeight='700'>
